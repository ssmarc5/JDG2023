...
class MachineDesJeuxProtocol(LineReader):
    ...
    def connection_made(self, transport):
        ...
        print(f"Serial port {self.name} successfully opened!")

    def handle_line(self, data):
        """ 
        Process data received from arduino
        """
        print(f"data received was:\n{data}")
        try:
    ...
    def connection_lost(self, exc):
        ...
        """
        if exc:
            print(f"Serial port {self.name} lost connection!")
    ...
    def stop_movement(self):
        ...
        """
        self.write_line(f'{self.STOP_CMD}')
    ...
    def write_stepper_cfg(self, max_speed_axis1, accel_axis1,
        ...
        """
        self.write_line(f'{self.WRITE_STEP_AXIS_CFG_CMD},{max_speed_axis1},{accel_axis1},\
    ...
    def read_stepper_cfg(self):
        ...
        """
        self.write_line(f'{self.READ_STEP_AXIS_CFG_CMD}')
    ...
    def write_move_threshold_config(self, stepper_threshold, servo_threshold):
        ...
        """
        self.write_line(f'{self.WRITE_MOVE_END_CFG_CMD},{stepper_threshold},{servo_threshold}')
    
    def read_move_threshold_config(self):
        """
        Send serial command to read the configured thresholds currently written to memory.
        """
        self.write_line(f'{self.READ_MOVE_END_CFG_CMD}')
    ...
    def write_servo_cfg(self, max_speed_axis4, accel_axis4,
        ...
        Parameters are in deg/seconds
        """
        self.write_line(f'{self.WRITE_SERVO_AXIS_CFG_CMD},{max_speed_axis4},{accel_axis4},\
    ...
    def read_servo_cfg(self):
        ...
        """
        self.write_line(f'{self.READ_SERVO_AXIS_CFG_CMD}')

def machine_path_handler():
    ...
    while True:
        try:
            ...
            print(f"pod_node: Serial port {ARDUINO_PORT} couldn't be opened:\n{e}")
            time.sleep(3)
    ...
    with ReaderThread(port, MachineDesJeuxProtocol) as protocol:
        ...
        while True:
            ...
            if val == 1:
                protocol.move_abs_angle(0,0,0,150,0,150)
            elif val == 2:
                protocol.move_relative_angle(9,0,0,0,0,0)
            elif val == 3:
