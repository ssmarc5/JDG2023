...
if("TRUE" STREQUAL "TRUE")
  set(control_node_SOURCE_PREFIX /home/itr/JDG2023/src/control_node)
  set(control_node_DEVEL_PREFIX /home/itr/JDG2023/devel)
  ...
  set(control_node_INSTALL_PREFIX /home/itr/JDG2023/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'control_node' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'control_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/itr/JDG2023/src/control_node/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT control_node_NUM_DUMMY_TARGETS)
      set(control_node_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::control_node::wrapped-linker-option${control_node_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR control_node_NUM_DUMMY_TARGETS "${control_node_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::control_node::wrapped-linker-option${control_node_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND control_node_LIBRARIES "${interface_target_name}")
...
set(control_node_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${control_node_dep}_FOUND)
      find_package(${control_node_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${control_node_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
